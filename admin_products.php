...
if(isset($_GET['delete']))
{
   ...
   $select_delete_image = mysqli_query($conn, "SELECT image FROM `products` WHERE pid = '$delete_id'") or die('query failed');
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="box-2"><img class="image" src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt=""></div>
         <div class="name"><?php echo $fetch_products['name']; ?></div>
         <div class="details"><?php echo $fetch_products['details']; ?></div>
         <a href="admin_update_product.php?update=<?php echo $fetch_products['pid']; ?>" class="option-btn">update</a>
