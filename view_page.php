...
<section class="quick-view">
    ...
    <?php  
        ...
        {
            $pid = $_GET['pid'];
            $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE pid = '$pid'") or die('query failed');
    ...
    <form action="" method="POST">
        <div class="box">
         <img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="" class="image"></div>
