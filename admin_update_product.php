...
if(isset($_POST['update_product']))
{
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$name', details = '$details', price = '$price' WHERE pid = '$update_p_id'") or die('query failed');
   ...
   if(!empty($image))
   {
      ...
      {
         mysqli_query($conn, "UPDATE `products` SET image = '$image' WHERE pid = '$update_p_id'") or die('query failed');
...
<head>
   ...
   <title>UDPATE PRODUCTS FNFScarf</title>
...
<?php
   ...
   $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE pid = '$update_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="hidden" value="<?php echo $fetch_products['pid']; ?>" name="update_p_id">
